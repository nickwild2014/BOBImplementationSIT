...
public class AccountAccountDetailsAdaptee extends ServiceProcessorUtil implements AdapteeInterface {

	private final static Logger logger = Logger.getLogger(AccountAccountDetailsAdaptee.class.getName());

	public AccountAccountDetailsAdaptee(String inputXml)
			throws ParserConfigurationException, SAXException, IOException, JAXBException {
		super(inputXml);
	}

	public AccountAccountDetailsAdaptee() {
	}
	...
	public static void main(String[] args) {
		...
		AccountAccountDetailsAdaptee AccountAccountDetailsAdaptee = new AccountAccountDetailsAdaptee();
		try {
			...
			String resp = AccountAccountDetailsAdaptee.process(testxml);
	...
	public String process(String tirequestXML) {
		...
		try {
			...
			if (bankResponse != null && !bankResponse.isEmpty()) {
				...
				tiResponse = getDefaultErrorResponse("Account Details: No record found [IM]");
			}
		...
		System.out.println(" ************ Account Details adaptee process ended ************ ");
		return tiResponse;
		...
		try {
			...
			try {
				InputStream anInputStream = BackOfficeBatchAdaptee.class.getClassLoader()
						.getResourceAsStream(RequestResponseTemplate.ACCOUNT_DETAILS_TI_RESPONSE_TEMPLATE);
	...
	public String getDefaultErrorResponse(String errorMsg) {
		...
		System.out.println("***** Account Details error response initiated *****");
	...
	public String getBankRequestFromTiRequest(String requestXML)
		...
		try {
			...
			String accountFormat = XPathParsing.getValue(requestXML,
					"/ServiceRequest/AccountDetailsRequest/AccountFormat");
			String accountNumber = XPathParsing.getValue(requestXML,
					"/ServiceRequest/AccountDetailsRequest/AccountNumber");
			System.out.println(accountNumber);
			tiReqValues.put("accountFormat", accountFormat);
			tiReqValues.put("accountNumber", accountNumber);

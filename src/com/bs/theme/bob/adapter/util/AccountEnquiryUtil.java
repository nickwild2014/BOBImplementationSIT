 ...
 * @author Bluescope
 */
public class AccountEnquiryUtil {

	private final static Logger logger = Logger.getLogger(AccountEnquiryUtil.class.getName());
	...
	private String getBankRequestFromTiRequest(String accountNumber)
		...
		try {
			anInputStream = AccountEnquiryUtil.class.getClassLoader()
	...
	public static void main(String a[]) throws Exception {
		...
		// AccountEnquiryUtil as = new AccountEnquiryUtil();
		// String responseXML = as.process("0123456");
